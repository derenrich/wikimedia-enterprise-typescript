...
export const parseLogLevel = (maybeLevel: string | undefined, sourceName: string, client: WikimediaEnterprise): LogLevel | undefined => {
  if (!maybeLevel) {
    return undefined;
  }
...
export function loggerFor(client: WikimediaEnterprise): Logger {

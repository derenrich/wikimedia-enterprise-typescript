import fs from 'fs';
import type { ResponseLike } from 'wikimedia-enterprise/internal/to-file';
import { toFile } from 'wikimedia-enterprise/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('wikimedia-enterprise/core/uploads');
    await expect(

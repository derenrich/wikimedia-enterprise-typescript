...
describe('resource projects', () => {
  ...
  test.skip('create: request options and params are passed correctly', async () => {
    ...
    await expect(client.projects.create({ fields: ['string'], filters: [{ field: 'field', value: 'value' }] }, { path: '/_stainless_unknown_path' }))
      .rejects
  ...
  test.skip('retrieve: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.projects.retrieve('x', { fields: ['name'] }, { path: '/_stainless_unknown_path' }))
      .rejects
      .toThrow(WikimediaEnterprise.NotFoundError);
  });
  ...
  test.skip('update: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.projects.update('x', { fields: ['string'] }, { path: '/_stainless_unknown_path' }))
      .rejects
      .toThrow(WikimediaEnterprise.NotFoundError);
  });
  ...
  test.skip('list: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.projects.list({ fields: ['name'], filters: [{ field: 'field', value: 'value' }] }, { path: '/_stainless_unknown_path' }))
      .rejects
      .toThrow(WikimediaEnterprise.NotFoundError);
  });
});

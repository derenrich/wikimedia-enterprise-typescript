...
describe('resource login', () => {
  ...
  test.skip('authenticate: only required params', async () => {
    const responsePromise = client.login.authenticate({ password: 'password', username: 'username' });
  ...
  test.skip('authenticate: required and optional params', async () => {
    const response = await client.login.authenticate({ password: 'password', username: 'username' });
  });
});
